  ...
  return (
    <main className="w-full max-w-5xl mx-auto px-6 pt-32 pb-32 space-y-24">
      ...
      <section className="space-y-6">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-700 font-light leading-relaxed max-w-4xl border-l-4 border-crimson pl-6 mt-10">
            Gujarat's agricultural and industrial water supply is overwhelmingly dependent on a <strong className="font-semibold text-gray-900">single engineering marvel — the Sardar Sarovar (Narmada) project</strong>. Meanwhile, North Gujarat's aquifers are being pumped dry at rates that exceed natural recharge, creating a ticking time bomb beneath the surface.
          </p>
        </motion.div>
      </section>
      ...
      <div className="space-y-20">
        ...
        <Section icon={<Droplets className="w-8 h-8 text-teal-600" />} title="The Narmada Lifeline: Single Point of Failure">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <DataCard title="Scale of Dependency">
              <p className="text-gray-600 mb-4 leading-relaxed">
                The Sardar Sarovar Dam supplies water to <strong className="text-gray-900">3 crore people</strong> and irrigates <strong className="text-gray-900">17.92 lakh hectares in Gujarat</strong> and 2.46 lakh hectares in Rajasthan.<Ref n={4} /> The canal network stretches 458 km in the main canal and over <strong>70,000 km</strong> of total canals, reaching 17 districts, 77 talukas, and thousands of villages.<Ref n={5} />
              </p>
              <p className="text-gray-600 leading-relaxed">
                Critically, <strong className="text-gray-900">75% of Gujarat's command area is classified as drought-prone</strong>, meaning these regions have virtually no alternative water source.<Ref n={1} />
              </p>
            </DataCard>

            <DataCard title="Water Allocation & Dependability Risk">
              <p className="text-gray-600 mb-4 leading-relaxed">
                Under the Narmada Water Disputes Tribunal (1979), Gujarat is allocated <strong className="text-gray-900">9 MAF (Million Acre Feet)</strong> out of 28 MAF total Narmada water, calculated at only <strong>75% dependability</strong> — meaning the probability of receiving the full allocation exists for only 3 out of every 4 years.<Ref n={3} />
              </p>
              <p className="text-gray-600 leading-relaxed">
        ...
        <Section icon={<AlertTriangle className="w-8 h-8 text-red-500" />} title="Groundwater Depletion: The Silent Crisis">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <DataCard title="North Gujarat Aquifer: 95% Withdrawal">
              <p className="text-gray-600 mb-4 leading-relaxed">
                The North Gujarat alluvial aquifer, covering <strong className="text-gray-900">49,914 km²</strong> (47% of Gujarat's total cropped area), is classified as <strong>over-exploited</strong> by the CGWB.<Ref n={6} /> Anthropogenic withdrawal is estimated at <strong className="text-gray-900">95% of the annual recharge of 6.88 km³</strong>.<Ref n={6} />
              </p>
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-red-700"><AlertTriangle className="w-5 h-5 text-red-500" /> Withdrawal exceeds net availability in multiple blocks</li>
                <li className="flex items-center gap-2 text-red-700"><AlertTriangle className="w-5 h-5 text-red-500" /> 13% increase in overdraft for irrigation during 2004-2009<Ref n={8} /></li>
              </ul>
            </DataCard>

            <DataCard title="Fluorosis & Contamination" alert={true}>
              <p className="text-gray-600 mb-4 leading-relaxed">
                Over-abstraction has triggered <strong className="text-gray-900">high fluoride contamination</strong> in the North Gujarat aquifer and salinity ingression along the coastal Saurashtra Peninsula.<Ref n={6} /> Fluoride levels in <strong className="text-gray-900">Banaskantha and Patan districts reach 17.5 mg/L</strong> — over 11 times the WHO safe limit of 1.5 mg/L. In Mehsana district, fluorosis has disabled workers, reduced earning capacity, and plunged households into cycles of wage loss and medical bills.<Ref n={7} />
              </p>
              <p className="text-gray-600 mb-4 leading-relaxed">
                District-level extraction data reveals alarming hotspots: <strong className="text-gray-900">Banaskantha at 115% of recharge, Mehsana at 132%, and Patan at 108%</strong> — all extracting more water than nature can replenish annually. These three districts alone account for 40% of North Gujarat's total groundwater withdrawal.
              </p>
              <p className="text-gray-600 leading-relaxed">
        ...
        {/* Agricultural Impact */}
        <Section icon={<MapPin className="w-8 h-8 text-green-600" />} title="Agricultural Dependencies & Benefits">
          <div className="bg-white/70 p-10 rounded-3xl border border-gray-200 shadow-xl backdrop-blur-md relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-teal-200 rounded-full blur-[80px] -mr-32 -mt-32 pointer-events-none" />
            <h3 className="text-3xl font-serif font-bold mb-6 text-gray-900 relative z-10">Narmada-Enabled Crop Diversification</h3>
        ...
        <Section icon={<Factory className="w-8 h-8 text-amber-600" />} title="Industrial Water Demand: The Invisible Competitor">
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <DataCard title="Factories vs. Farms: The Narmada Diversion">
              <p className="text-gray-600 mb-4 leading-relaxed">
                The Gujarat government originally mandated that only <strong className="text-gray-900">11% of Narmada water</strong> would serve industrial and domestic purposes. By 2016, the actual figure had risen to over <strong className="text-gray-900">18%</strong> — nearly double the original provision.<Ref n={11} /> Industries in Kutch and Saurashtra alone were drawing <strong className="text-gray-900">844.85 MLD</strong> against their allocation of just 675.88 MLD — a 25% overshoot.<Ref n={11} />
              </p>
              <p className="text-gray-600 leading-relaxed">
                Meanwhile, the Narmada main canal is now <strong className="text-gray-900">92% complete</strong> (as of 2025), but the critical last-mile distribution network — sub-minors and field channels — remains only <strong>36% operational</strong>, covering 27,189 km out of the planned 74,000 km — leaving tail-end farmers far short of their promised allocation.<Ref n={12} /> During the 2019 drought, industries in Mundra and Kutch continued receiving Narmada water while <strong>no water was released for agricultural purposes</strong> in Kutch — the very region the dam was built to serve.<Ref n={11} />
              </p>
            </DataCard>

            <DataCard title="SSNNL Revenue: The Money Follows Industry" alert={true}>
              <p className="text-gray-600 mb-4 leading-relaxed">
                SSNNL's total water revenue reached <strong className="text-gray-900">Rs 2,733 crore in FY25</strong>. The breakdown exposes the allocation reality: industrial consumers contributed <strong>Rs 545 crore</strong> while agriculture — the original justification for the dam — generated just <strong className="text-gray-900">Rs 11.72 crore</strong>. Drinking water contributed Rs 1,876 crore. Industry pays 47x more per unit than agriculture, giving SSNNL a powerful financial incentive to prioritize industrial allocation.
              </p>
            </DataCard>

            <DataCard title="The GWIL Loophole">
              <p className="text-gray-600 mb-4 leading-relaxed">
                The state-owned Gujarat Water Infrastructure Ltd (GWIL) was constituted as a special purpose vehicle whose stated mission is to provide <strong className="text-gray-900">drinking water</strong>. Being an SPV, GWIL does not fall under the RTI Act. However, investigations revealed that GWIL distributes water to both domestic and <strong className="text-gray-900">industrial consumers</strong> — effectively routing Narmada water to factories under a drinking-water mandate.<Ref n={11} />
              </p>
              <p className="text-gray-600 leading-relaxed">
      ...
      <Section icon={<Droplets className="w-8 h-8 text-blue-600" />} title="SAUNI Scheme & Water Transfer Infrastructure">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <DataCard title="Saurashtra Narmada Avataran Irrigation (SAUNI)">
            <p className="text-gray-600 mb-4 leading-relaxed">
              The SAUNI scheme — designed to fill 115 dams in 11 Saurashtra districts using Narmada water via a <strong className="text-gray-900">1,130 km pipeline network</strong> — addresses the structural water deficit that rain-dependent Saurashtra has suffered for decades.
            </p>
            <p className="text-gray-600 leading-relaxed">
              As of 2025, the scheme is <strong className="text-gray-900">95% complete at a revised cost of Rs 18,563 crore</strong> — a 69% cost overrun from the original Rs 11,000 crore estimate. Phases 1 and 2 are fully operational (523 km, 79 dams filled); Phase 3 (335 km) is 98% complete; Phase 4 (271 km) is 87% complete. Even after full completion, the scheme merely redistributes Narmada water — it creates no new water source.
            </p>
          </DataCard>
      ...
      <Section icon={<AlertTriangle className="w-8 h-8 text-red-500" />} title="Urban Water Stress & Per Capita Deficit">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <DataCard title="Surat: The Flood-Drought Paradox">
            <p className="text-gray-600 mb-4 leading-relaxed">
              Surat — India's fastest-growing city — depends on the <strong className="text-gray-900">Tapi River and Ukai Dam</strong> for its water supply. The paradox: the city faces catastrophic floods during monsoon (12 major floods since 1883) and water stress during summer when the Tapi runs low.
            </p>
            <p className="text-gray-600 leading-relaxed">
