...
export default function Home() {
  const sectors = useMemo(() => [
    { id: 'infrastructure', title: "Infrastructure & Logistics", icon: <Ship className="w-8 h-8 text-blue-600" />, desc: "Maritime gateway monopoly, bridge collapses, and zero digital connectivity.", path: "/infrastructure", stat: "500.8 MMT", statLabel: "APSEZ FY26 Cargo", sources: 22 },
    { id: 'energy', title: "Energy Grid & Power Supply", icon: <Zap className="w-8 h-8 text-yellow-600" />, desc: "Imported coal lock-in, 550 Morbi units shut, and grid collapse events.", path: "/energy", stat: "550+", statLabel: "Morbi Units Shut (2026)", sources: 21 },
    { id: 'materials', title: "Industrial Raw Materials", icon: <Factory className="w-8 h-8 text-gray-600" />, desc: "Russia now #1 crude supplier, 65-70% Chinese APIs, 100% potash import.", path: "/materials", stat: "36%", statLabel: "Crude from Russia", sources: 27 },
    { id: 'water', title: "Water Security", icon: <Droplets className="w-8 h-8 text-teal-600" />, desc: "Narmada single point of failure, fluoride at 17.5 mg/L, industry vs farms.", path: "/water", stat: "132%", statLabel: "Mehsana Extraction Rate", sources: 23 },
    { id: 'labor', title: "Migrant Labor Ecosystem", icon: <Users className="w-8 h-8 text-purple-600" />, desc: "5-6 lakh workers fled in 2026, US tariffs crush diamonds, Rs 100 Cr/day losses.", path: "/labor", stat: "5-6L", statLabel: "Workers Fled (2026)", sources: 29 },
    { id: 'economics', title: "Governance & Fiscal", icon: <TrendingUp className="w-8 h-8 text-green-600" />, desc: "CAG flags overstated surplus, OTR at 4.9%, GIFT City 20-year tax holiday.", path: "/economics", stat: "15.3%", statLabel: "Debt-to-GSDP (FY25)", sources: 29 },
    { id: 'education', title: "Education & Healthcare", icon: <GraduationCap className="w-8 h-8 text-pink-600" />, desc: "2.4 lakh dropouts (#1 in India), primary GER collapsed to 79.6%.", path: "/education", stat: "2.4L", statLabel: "Annual Dropouts (#1)", sources: 20 },
    { id: 'environment', title: "Environment & Climate", icon: <TreePine className="w-8 h-8 text-emerald-600" />, desc: "Sabarmati 'cesspool' ruling, Deesa 21 dead, 36 sq km mangrove loss.", path: "/environment", stat: "21", statLabel: "Deesa Explosion Deaths", sources: 29 },
    { id: 'migrant-discrimination', title: "Migrant Discrimination", icon: <ShieldAlert className="w-8 h-8 text-red-600" />, desc: "2018 pogrom: 20,000+ fled. Language barriers, wage theft, bonded labour, zero welfare.", path: "/migrant-discrimination", stat: "20K+", statLabel: "Workers Attacked (2018)", sources: 39 },
    { id: 'agriculture', title: "Agriculture & Agrarian Distress", icon: <Wheat className="w-8 h-8 text-green-700" />, desc: "115% groundwater extraction in Banaskantha, six cotton-belt suicides (Nov 2025), PMFBY exit, 765 km coastal salinity.", path: "/agriculture", stat: "115%", statLabel: "Banaskantha Extraction", sources: 49 },
    { id: 'greentech', title: "Green Tech Dependency", icon: <Cpu className="w-8 h-8 text-cyan-600" />, desc: "90% China rare-earth, 100% imported wafers, <10 GIB left, 35 GW curtailment risk FY27, Khavda flooded.", path: "/greentech", stat: "90%", statLabel: "China RE Processing", sources: 50 },
    { id: 'chemical-governance', title: "Chemical Governance & Toxicity", icon: <FlaskConical className="w-8 h-8 text-orange-600" />, desc: "Golden Corridor toll, GPCB 60.9% vacant posts, DISH Bharuch 5 staff for 2,075 factories, Kolak 15-day pollution cycles.", path: "/chemical-governance", stat: "60.9%", statLabel: "GPCB Vacancy Rate", sources: 45 },
    { id: 'digital-sovereignty', title: "Digital Sovereignty & Data Dependency", icon: <Cable className="w-8 h-8 text-blue-600" />, desc: "0 submarine cable landings on a 1,600 km coastline. GIFT City backhauls via Mumbai. AWS hosts state e-gov.", path: "/digital-sovereignty", stat: "0", statLabel: "Intl. Cables in Gujarat", sources: 23 },
