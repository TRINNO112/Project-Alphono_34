  ...
  return (
    <main className="w-full max-w-5xl mx-auto px-6 pt-32 pb-32 space-y-24">
      ...
      <section className="space-y-6">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-700 font-light leading-relaxed max-w-4xl border-l-4 border-crimson pl-6 mt-10">
            Handling nearly <strong className="font-semibold text-gray-900">40% of India's total cargo volume</strong>, Gujarat operates as the nation's primary maritime gateway. However, its logistical backbone exhibits extreme corporate concentration and severe vulnerability bottlenecks.
          </p>
        </motion.div>
      </section>
      ...
      <div className="space-y-20">
        ...
        {/* Adani & DP World */}
        <Section icon={<Ship className="w-8 h-8 text-blue-600" />} title="Corporate Centralization & Monopolies">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <DataCard title="Adani Ports Dominance">
              <p className="text-gray-600 mb-6 leading-relaxed">
                Mundra Port became the first Indian port to handle over <strong className="text-gray-900">200 Million Metric Tonnes (MMT)</strong> of cargo in FY25.<Ref n={1} /> In FY26, APSEZ crossed a new milestone — <strong className="text-gray-900">500.8 MMT total cargo across all ports</strong> (+11% YoY), with a record 46 MMT in March 2026 alone. APSEZ now commands approximately <strong className="text-gray-900">28% of India's total port volumes</strong> and 45.8% of all-India container market share.<Ref n={2} /> Current capacity stands at <strong>633 MTPA</strong> across 15 ports, with a target of 1 billion tonnes by 2030.<Ref n={3} />
              </p>
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-gray-700"><CheckCircle className="w-5 h-5 text-green-500" /> 633 MTPA current capacity — largest in India<Ref n={8} /></li>
                <li className="flex items-center gap-2 text-red-700"><AlertTriangle className="w-5 h-5 text-red-500" /> Concession extended from 30 to 75 years without competitive bidding</li>
                <li className="flex items-center gap-2 text-red-700"><AlertTriangle className="w-5 h-5 text-red-500" /> Extreme single-entity centralization risk</li>
              </ul>
            </DataCard>
            ...
            <DataCard title="DP World Rail Oligopoly">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-gray-700"><CheckCircle className="w-5 h-5 text-green-500" /> 100+ owned container rakes</li>
                <li className="flex items-center gap-2 text-gray-700"><CheckCircle className="w-5 h-5 text-green-500" /> 7 inland terminals</li>
              </ul>
            </DataCard>
          </div>
            ...
            <DataCard title="The Delhi-Mumbai Expressway Delay" alert={true}>
              <div className="flex flex-col md:flex-row gap-8 items-start">
                ...
                <div className="md:w-1/3 w-full bg-red-100/50 p-6 rounded-xl border border-red-200 flex flex-col items-center text-center">
                  <span className="text-4xl font-bold text-red-600 mb-2">5%</span>
                  <span className="text-sm text-red-800 uppercase tracking-widest font-semibold">Package 8 Status</span>
                  <hr className="w-full border-red-300 my-4" />
                  <span className="text-lg font-serif text-red-900">Delayed to 2027-28</span>
                </div>
              </div>
            </DataCard>
        ...
        <Section icon={<Hammer className="w-8 h-8 text-gray-500" />} title="Raw Material Innovation: Steel Slag">
          <div className="bg-white/70 p-10 rounded-3xl border border-gray-200 shadow-xl backdrop-blur-md relative overflow-hidden">
            ...
            <h3 className="text-3xl font-serif font-bold mb-6 text-gray-900 relative z-10">Mitigating Aggregate Dependency</h3>
        ...
        <Section icon={<Wifi className="w-8 h-8 text-violet-500" />} title="Digital Infrastructure Dependencies">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <DataCard title="Zero Submarine Cable Landing Stations" alert={true}>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Despite possessing India's longest coastline at 1,600 km, Gujarat operates <strong className="text-gray-900">zero submarine cable landing stations</strong>. All 17 of India's international subsea cables land in just five cities — Mumbai, Chennai, Kochi, Tuticorin, and Thiruvananthapuram — with 15 of those 17 cables arriving within a <strong className="text-gray-900">six-kilometre stretch of Versova beach</strong> in Mumbai.<Ref n={11} /> An estimated 95% of India's international internet bandwidth flows through this single narrow corridor.<Ref n={11} />
              </p>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Gujarat's entire digital economy — GIFT City's financial platforms, Mundra's port logistics systems, Jamnagar's refinery operations — routes through Mumbai's bottleneck. Four proposals for Gujarat coast landing stations are under review as of mid-2025, but none are operational.<Ref n={9} /> TRAI Chairman Anil Kumar Lahoti has stated India needs a <strong className="text-gray-900">10x expansion</strong> in cable landing stations to compete globally, noting India accounts for just 1% of the world's stations.<Ref n={10} />
              </p>
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-red-700"><AlertTriangle className="w-5 h-5 text-red-500" /> Faults at Versova occur monthly; repairs take 3-5 months<Ref n={11} /></li>
                <li className="flex items-center gap-2 text-red-700"><AlertTriangle className="w-5 h-5 text-red-500" /> Red Sea disruptions can affect 25% of India's connectivity<Ref n={11} /></li>
              </ul>
            </DataCard>

            <DataCard title="Data Center Capacity Void">
              <p className="text-gray-600 mb-6 leading-relaxed">
                Mumbai alone accounts for <strong className="text-gray-900">52% of India's total data center capacity</strong>, with Chennai contributing another 21%. Gujarat remains largely absent from this landscape — a paradox for a state positioning GIFT City as a global financial technology hub.<Ref n={12} />
              </p>
              <p className="text-gray-600 mb-6 leading-relaxed">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-gray-700"><CheckCircle className="w-5 h-5 text-green-500" /> CtrlS GIFT City facility under construction<Ref n={12} /></li>
                <li className="flex items-center gap-2 text-red-700"><AlertTriangle className="w-5 h-5 text-red-500" /> No operational colocation data center capacity today</li>
              </ul>
            </DataCard>
          </div>
          ...
          <DataCard title="The Versova Single Point of Failure">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="md:w-1/3 w-full bg-violet-100/50 p-6 rounded-xl border border-violet-200 flex flex-col items-center text-center">
                <span className="text-4xl font-bold text-violet-600 mb-2">0</span>
                <span className="text-sm text-violet-800 uppercase tracking-widest font-semibold">Gujarat Cable Stations</span>
                <hr className="w-full border-violet-300 my-4" />
                <span className="text-lg font-serif text-violet-900">vs 17 in Mumbai/Chennai</span>
              </div>
            </div>
          </DataCard>
        </Section>
      ...
      {/* Port Ecosystem */}
      <Section icon={<Ship className="w-8 h-8 text-teal-600" />} title="The Gujarat Port Ecosystem: 604 MMT and Counting">
        <p className="text-gray-700 text-lg leading-relaxed mb-8">
          Gujarat's 49 ports (1 major + 48 minor) collectively handled <strong className="text-gray-900">604 MMT of cargo in FY25 — approximately 40% of India's total maritime cargo</strong>.<Ref n={15} /> In FY26, Deendayal Port (Kandla) surged to <strong className="text-gray-900">160 MMT</strong> — an 8.3% YoY jump — driven by coal and fertilizer imports. However, this dominance masks extreme concentration: Mundra alone accounted for 200 MMT (33% of the state's total) while a single private company (APSEZ) controlled 28% of all India's port volumes.<Ref n={13} />
        </p>
      ...
      <Section icon={<Train className="w-8 h-8 text-amber-600" />} title="Western Dedicated Freight Corridor & Rail Infrastructure">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <DataCard title="Western DFC: Gujarat's Freight Backbone">
            <p className="text-gray-600 mb-4 leading-relaxed">
              The <strong className="text-gray-900">1,506 km Western Dedicated Freight Corridor</strong> connects JNPT (Mumbai) to Dadri (UP) via Gujarat — with ~500 km running through Gujarat's territory including key junctions at Vadodara, Ahmedabad, and Palanpur.<Ref n={14} />
            </p>
            <p className="text-gray-600 leading-relaxed">
      ...
      <Section icon={<Plane className="w-8 h-8 text-indigo-600" />} title="Airport Infrastructure & Capacity Constraints">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <DataCard title="Ahmedabad: Capacity Crunch at India's 8th Busiest Airport">
            <p className="text-gray-600 mb-4 leading-relaxed">
              Sardar Vallabhbhai Patel International Airport served <strong className="text-gray-900">13 million passengers in FY26</strong>, with monthly traffic touching 1.2 million — a new record. The new Terminal 2 (Rs 1,450 crore) was inaugurated in 2025, expanding capacity to 20 million passengers.<Ref n={16} />
            </p>
            <p className="text-gray-600 leading-relaxed">
          ...
          <DataCard title="Air Cargo: Dwarfed by Mumbai">
            <p className="text-gray-600 mb-4 leading-relaxed">
              Gujarat's air cargo volumes remain <strong className="text-gray-900">negligible compared to Mumbai</strong> — Ahmedabad handles roughly 90,000 MT of cargo annually versus Mumbai's 850,000+ MT. The diamond industry in Surat — the world's largest polishing hub — still routes 90% of its high-value exports through Mumbai's air cargo hub.
            </p>
            <p className="text-gray-600 leading-relaxed">
