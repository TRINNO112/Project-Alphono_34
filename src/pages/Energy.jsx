  ...
  return (
    <main className="w-full max-w-5xl mx-auto px-6 pt-32 pb-32 space-y-24">
      ...
      <div className="space-y-20">
        ...
        {/* Imported Coal */}
        <Section icon={<Flame className="w-8 h-8 text-orange-600" />} title="Imported Coal: The Coastal Thermal Trap">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <DataCard title="Adani Mundra Thermal — 4,620 MW">
              <p className="text-gray-600 mb-6 leading-relaxed">
                Running on blended sub-bituminous coal, approximately <strong className="text-gray-900">70% imported from Adani's own mine in Bunyu, East Kalimantan, Indonesia</strong>, with the remainder sourced from Mahanadi Coalfields in Odisha under a 6.405 MTPA fuel supply agreement.<Ref n={1} />
              </p>
            ...
            <DataCard title="Tata Mundra UMPP — 4,000 MW" alert={true}>
              <p className="text-gray-600 mb-6 leading-relaxed">
                India's first supercritical coal-fired plant, consuming up to <strong className="text-gray-900">12 million tonnes of imported coal per year</strong>.<Ref n={2} /> The plant supplies power to five states: Gujarat (1,805 MW), Maharashtra (760 MW), Punjab (475 MW), Rajasthan (380 MW), and Haryana (380 MW).<Ref n={3} />
              </p>
              ...
              <p className="text-gray-600 leading-relaxed">
                In <strong className="text-gray-900">2025-26, the Tata Mundra UMPP was shut for 9 consecutive months</strong> due to unviable imported coal costs — removing 4,000 MW from the grid during the exact period Gujarat needed peak capacity. This single plant's downtime created a <strong className="text-gray-900">3,042 MW peak deficit</strong>, forcing emergency purchases from the central pool at Rs 20+/unit spot rates.
              </p>
            </DataCard>
          </div>
        ...
        <Section icon={<AlertTriangle className="w-8 h-8 text-red-500" />} title="LNG Import Terminals: The Hormuz Chokepoint">
          <p className="text-gray-700 text-lg leading-relaxed mb-8">
            Gujarat's LNG terminals account for roughly <strong className="text-gray-900">60% of India's total LNG import capacity</strong>, with the state's gas pipeline network stretching over 5,850 km — 25% of the country's total.<Ref n={7} />
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <DataCard title="Dahej Terminal (Petronet LNG)">
              <p className="text-gray-600 mb-4 leading-relaxed">
                India's largest LNG terminal at <strong className="text-gray-900">17.5 MTPA</strong> capacity, operating at an extraordinary <strong className="text-gray-900">100.3% utilization</strong>.<Ref n={5} /> It meets more than one-third of India's entire LNG demand. Expansion to 22.5 MTPA is underway.<Ref n={4} />
              </p>
              <div className="bg-red-50/60 p-4 rounded-xl border border-red-200">
                <p className="text-red-800 text-sm font-semibold">Hormuz Exposure: ~76% of Dahej's 14.8 MT supply transits through the Strait of Hormuz<Ref n={8} /></p>
              </div>
            </DataCard>

            <DataCard title="Hazira Terminal (Shell India)">
              <p className="text-gray-600 mb-4 leading-relaxed">
                Capacity of <strong className="text-gray-900">5.2 MTPA</strong>, currently at 38.5% utilization.<Ref n={6} /> An approved expansion will add 19 MTPA of regasification capacity, bringing total to 26.2 MTPA.<Ref n={6} />
              </p>
              <div className="bg-green-50/60 p-4 rounded-xl border border-green-200">
                <p className="text-green-800 text-sm font-semibold">Hormuz Exposure: ~25% — diversified sourcing from US, Russia, Australia<Ref n={8} /></p>
              </div>
            </DataCard>
          </div>
        ...
        {/* Renewables Paradox */}
        <Section icon={<Wind className="w-8 h-8 text-green-600" />} title="The Renewable Energy Paradox">
          <p className="text-gray-700 text-lg leading-relaxed mb-8">
            Gujarat leads India with <strong className="text-gray-900">42.583 GW</strong> of installed renewable capacity (16.5% of India's total), ranking 1st in wind (14,821 MW) and 1st in rooftop solar (6,413 MW).<Ref n={9} /> Yet this headline number masks a critical gap.
          </p>
      ...
      <Section icon={<Flame className="w-8 h-8 text-red-600" />} title="The 2026 Gas Crisis: Real-Time Vulnerability Exposed">
        <p className="text-gray-700 text-lg leading-relaxed mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <DataCard title="Workforce Exodus: The Energy-Labor Nexus">
            <p className="text-gray-600 mb-4 leading-relaxed">
              When factories shut, migrant workers — who have no savings buffer or formal employment protections — immediately began returning to their home states.<Ref n={13} /> The energy crisis thus triggered a <strong className="text-gray-900">labor crisis</strong>, compounding the industrial shutdown.
            </p>
            <p className="text-gray-600 leading-relaxed">
      ...
      {/* Grid Dependency */}
      <Section icon={<Zap className="w-8 h-8 text-yellow-600" />} title="Central Grid Dependency & Transmission Constraints">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <DataCard title="Interstate Power Imports">
            <p className="text-gray-600 mb-4 leading-relaxed">
              Despite its massive installed capacity, Gujarat is a <strong className="text-gray-900">net importer of electricity during peak demand periods</strong>. During summer 2025, the state imported up to 4,000 MW from the central grid — sourced from Chhattisgarh, Madhya Pradesh, and the Southern grid — to meet industrial baseload requirements.
            </p>
            <p className="text-gray-600 leading-relaxed">
