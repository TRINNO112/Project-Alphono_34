    ...
    <main className="w-full max-w-5xl mx-auto px-6 pt-32 pb-32 space-y-24">
      ...
      >
        <p className="text-gray-500 italic font-serif">
          This summary synthesizes findings from 473+ cited sources across 14 pillars plus the Index Mercantilis global-trade module. See individual pillar pages for full references and source URLs.
        </p>
      </motion.section>
    </main>
  )
