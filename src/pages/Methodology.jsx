    ...
    <main className="w-full min-h-screen bg-gray-50 font-sans pt-28 pb-32">
      ...
      <div className="max-w-3xl mx-auto px-5">
        ...
        <motion.section {...fade(0.1)} className="mb-16">
          <SectionNumber n="1" />
          <h2 className="text-2xl font-serif font-bold text-gray-900 mb-4">Research Framework</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
            This investigation employs a <strong className="text-gray-900">mixed-methods structural dependency analysis</strong> — combining quantitative data extraction from government records with qualitative assessment drawn from investigative journalism, court proceedings, and field reporting. Phase II expanded the scope with deep-dive research into agrarian distress, green technology supply chain vulnerabilities, and industrial chemical toxicity governance. Phase III (April 2026) added a 13th pillar on digital sovereignty and a dedicated cartographic audit of Gujarat's maritime trade dependencies.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
            The core thesis — that Gujarat's industrial economy contains deep, under-examined structural vulnerabilities — is tested across <strong className="text-gray-900">13 interdependent pillars</strong>: Infrastructure, Energy, Water, Labor, Fiscal Governance, Raw Materials, Education, Environment, Migrant Discrimination, Agriculture &amp; Agrarian Distress, Green Tech Dependency, Chemical Governance, and Digital Sovereignty.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
            A parallel cartographic track — the <strong className="text-gray-900">Index Mercantilis</strong> — maps Gujarat's external trade chokepoints (Hormuz, Malacca, Bab-el-Mandeb, Suez, Cape of Good Hope) and the origin/destination nodes that feed the state's refineries, LNG terminals, coal-fired power, steel mills, and chemical hubs. This module is sourced from 41 independent tanker-tracking, commodity, and geopolitical data streams.
          </p>
          <p className="text-gray-600 leading-relaxed">
            Each pillar is not analyzed in isolation. The research deliberately maps <strong className="text-gray-900">cross-pillar dependencies</strong> — for example, how energy price shocks (Pillar 2) cascade into labor exodus (Pillar 4), which in turn impacts industrial output (Pillar 6) and fiscal receipts (Pillar 5).
          </p>
        </motion.section>
            ...
            {sourceBreakdown.map((s) => (
              <div key={s.type}>
                <div className="flex items-baseline justify-between mb-1.5">
                  ...
                  <span className="text-xs font-mono text-gray-500">{s.count} sources · {s.pct}%</span>
                </div>
                ...
                <p className="text-xs text-gray-400 mt-1">{s.examples}</p>
              </div>
            ))}
          </div>

          <div className="p-4 bg-gray-100/60 border border-gray-200/60 rounded-xl">
            <div className="flex items-start gap-3">
              <Database className="w-4 h-4 text-crimson mt-0.5 shrink-0" />
              <p className="text-sm text-gray-600 leading-relaxed">
                All sources are accessible via the <strong className="text-gray-800">Source Data</strong> page, organized by pillar with type badges, publisher attribution, and direct URLs.
              </p>
            </div>
          </div>
        </motion.section>
        ...
        <motion.section {...fade(0.1)} className="mb-16">
          <SectionNumber n="3" />
          <h2 className="text-2xl font-serif font-bold text-gray-900 mb-6">Verification Framework</h2>
          <p className="text-gray-600 leading-relaxed mb-8">
          ...
          <div className="space-y-6">
            {verificationSteps.map((v) => (
              <div key={v.step} className="flex gap-5">
                <div className="shrink-0 w-12 h-12 rounded-xl bg-crimson/5 border border-crimson/10 flex items-center justify-center">
        ...
        <motion.section {...fade(0.1)} className="mb-16">
          <SectionNumber n="4" />
          <h2 className="text-2xl font-serif font-bold text-gray-900 mb-4">Source Classification Criteria</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="text-left px-4 py-3 font-semibold text-gray-900">Criteria</th>
                </tr>
              </thead>
              <tbody className="text-gray-600">
                <tr className="border-b border-gray-100">
                  <td className="px-4 py-3"><span className="px-2 py-0.5 bg-blue-50 text-blue-600 text-xs font-bold rounded">Govt</span></td>
                ...
                <tr className="border-b border-gray-100">
                  <td className="px-4 py-3"><span className="px-2 py-0.5 bg-red-50 text-red-600 text-xs font-bold rounded">Media</span></td>
                ...
                <tr className="border-b border-gray-100">
                  <td className="px-4 py-3"><span className="px-2 py-0.5 bg-purple-50 text-purple-600 text-xs font-bold rounded">Academic</span></td>
                ...
                <tr className="border-b border-gray-100">
                  <td className="px-4 py-3"><span className="px-2 py-0.5 bg-amber-50 text-amber-600 text-xs font-bold rounded">Industry</span></td>
                ...
                <tr>
                  <td className="px-4 py-3"><span className="px-2 py-0.5 bg-emerald-50 text-emerald-600 text-xs font-bold rounded">Legal</span></td>
        ...
        <motion.section {...fade(0.1)} className="mb-16">
          <SectionNumber n="5" />
          <h2 className="text-2xl font-serif font-bold text-gray-900 mb-4">Limitations & Bias Acknowledgment</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <div className="space-y-3">
            {limitations.map((lim, i) => (
              <div key={i} className="flex gap-3 p-4 bg-gray-100/50 border border-gray-200/50 rounded-xl">
                <AlertTriangle className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
                <p className="text-sm text-gray-600 leading-relaxed">{lim}</p>
              </div>
            ))}
          </div>
        </motion.section>
        ...
        <motion.section {...fade(0.1)}>
          <SectionNumber n="6" />
          <h2 className="text-2xl font-serif font-bold text-gray-900 mb-4">Citation Standard</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
            All pillar pages use inline footnote markers <span className="text-crimson font-mono text-xs">[1]</span> <span className="text-crimson font-mono text-xs">[2]</span> linking to a numbered <strong className="text-gray-800">Sources</strong> section at the bottom of each page. Every source includes:
          </p>
        ...
        <motion.section {...fade(0.1)} className="mt-16">
          <SectionNumber n="7" />
          <h2 className="text-2xl font-serif font-bold text-gray-900 mb-4">Phase 3: Unaudited District Protocol</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
            For the 16 districts currently pending a deep audit, preliminary vulnerability matrices are constructed using predictive gap-analysis. This involves extrapolating localized risk from state-wide aggregates, using satellite telemetry for crop and environmental distress mapping, and leveraging spatial proxy data. Full factual grounding is marked as <strong className="text-gray-900">Pending Synthesis</strong> until primary RTI responses, governmental dataset validations, and empirical field reports complete the verification pipeline.
          </p>
        </motion.section>
        ...
        <motion.section {...fade(0.1)} id="simulator" className="mt-20">
          ...
          <SectionNumber n="8" />
          <h2 className="text-3xl font-serif font-bold text-gray-900 mb-3 leading-tight">Break Simulator — How the math works</h2>
          <p className="text-gray-600 leading-relaxed mb-8">
          ...
          {/* §8.1 What a "lever" is */}
          <h3 className="text-xl font-serif font-bold text-gray-900 mt-10 mb-3 flex items-center gap-2">
            <span className="text-[11px] font-mono font-bold text-crimson tracking-widest">8.1</span>
            What a &ldquo;lever&rdquo; is
          </h3>
          <p className="text-gray-600 leading-relaxed mb-3">
            A lever is one shock — a real, documented disruption like &ldquo;Russian crude supply cut&rdquo;, &ldquo;Mundra port closed for N days&rdquo;, &ldquo;migrant violence festival period&rdquo;, &ldquo;Versova subsea cable severance&rdquo;. There are <strong className="text-gray-900">20 levers</strong> grouped into four research streams:
          </p>
          <ul className="space-y-1.5 text-sm text-gray-600 mb-4 ml-1">
            <li><strong className="text-gray-900">Materials</strong> — Russian crude, Chinese APIs, Dahej LNG, solar PV imports, pharma single-points-of-failure</li>
            <li><strong className="text-gray-900">Physical</strong> — Mundra closure, Narmada deficit, Tapi flooding Surat, heatwave + AQI black swan, Saurashtra bridge collapses</li>
            <li><strong className="text-gray-900">Human</strong> — migrant violence, diamond-export collapse, textile-export collapse, structural discrimination cascade, Saurashtra reverse migration</li>
            <li><strong className="text-gray-900">Frontier</strong> — Versova cable severance, China green-tech shock, BT cotton collapse, Saurashtra/Kutch monsoon failure</li>
          </ul>
          <p className="text-gray-600 leading-relaxed">
          ...
          <div className="p-4 bg-gray-900 rounded-xl mb-4 overflow-x-auto">
          ...
          <div className="space-y-3 mb-4">
            <div className="p-4 border border-gray-200 rounded-xl">
              <p className="font-semibold text-gray-900 mb-1">Asset share <span className="text-xs text-gray-400 ml-2">(typically 0.0 – 1.0)</span></p>
              <p className="text-sm text-gray-600 leading-relaxed">What fraction of the pillar&apos;s critical asset base is exposed to this shock. Example: <em>Russian crude → Materials</em> uses an asset share of 0.56, the weighted average of RIL Jamnagar&apos;s Russian intake (~36%) and Nayara Vadinar&apos;s (~70%) — both directly cited from the Al Jazeera and Business Standard 2025 reports.</p>
            </div>
            <div className="p-4 border border-gray-200 rounded-xl">
              <p className="font-semibold text-gray-900 mb-1">Dependency weight <span className="text-xs text-gray-400 ml-2">(typically 0.5 – 1.0)</span></p>
              <p className="text-sm text-gray-600 leading-relaxed">How load-bearing that asset is to the pillar. A refinery feedstock cut hits Materials at weight 0.85 because petrochem cracker output drops near-linearly with feed availability. A truckers strike hits Materials at weight ~0.4 because there&apos;s rail substitution at the margin.</p>
            </div>
            <div className="p-4 border border-gray-200 rounded-xl">
              <p className="font-semibold text-gray-900 mb-1">Propagation factor <span className="text-xs text-gray-400 ml-2">(typically 1.0 – 1.5)</span></p>
              <p className="text-sm text-gray-600 leading-relaxed">Multiplier for second-order effects within the same pillar — supplier concentration, lack of substitutes, no strategic reserve. A propagation of 1.4 means &ldquo;one unit of asset loss converts to 1.4 units of pillar damage because the rest of the system can&apos;t absorb it.&rdquo;</p>
            </div>
          </div>
          <p className="text-gray-600 leading-relaxed">
            The product is capped at 100. The result you see in the impact bars is the <strong className="text-gray-900">linear interpolation</strong> of this headline %, scaled by current lever value: a slider at 50/100 yields 0.5 × result; a toggle off yields 0.
          </p>

          {/* §8.3 Why values, not just signals */}
          <h3 className="text-xl font-serif font-bold text-gray-900 mt-10 mb-3">
            <span className="text-[11px] font-mono font-bold text-crimson tracking-widest mr-2">8.3</span>
            Why concrete %s, not vague signals
          </h3>
          <p className="text-gray-600 leading-relaxed">
            Every factor in the &ldquo;Why?&rdquo; popover is anchored to a published number — a Kpler tanker share, a CAG audit objection, a Reuters/Reuters Business Standard report, a TRAI / NPCIL filing, a peer-reviewed dependency study. The simulator does <strong className="text-gray-900">not</strong> hallucinate magnitudes. Where a citation gap exists (rare) the lever carries an explicit <code className="font-mono text-xs bg-gray-100 px-1 rounded">pendingData</code> flag and the map shows an &ldquo;Estimates pending data&rdquo; tag.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-3">
            Each lever names primary districts with reasons (Russian crude → Jamnagar &ldquo;RIL SEZ + Sikka port&rdquo;, Devbhumi Dwarka &ldquo;Nayara directly sanctioned&rdquo;, Bharuch &ldquo;Dahej cracker feedstock&rdquo;…). Primary districts take the full hit. The rest of Gujarat absorbs a <strong className="text-gray-900">15% statewide ripple</strong> of that hit — the rationale is that no district is fully insulated from another&apos;s shock once you account for inter-district labor flows, fiscal transfers, and supply-chain bridges.
          </p>
          <p className="text-gray-600 leading-relaxed">
          ...
          <p className="text-gray-600 leading-relaxed mb-3">
            Each lever carries two scalars: <code className="font-mono text-xs bg-gray-100 px-1 rounded">gdpCrorePerUnit</code> and <code className="font-mono text-xs bg-gray-100 px-1 rounded">jobsPerUnit</code>. &ldquo;Per unit&rdquo; means per slider-point or per active toggle.
          </p>
          <p className="text-gray-600 leading-relaxed mb-3">
          ...
          <p className="text-gray-600 leading-relaxed">
            For levers where a buffer stock exists (oil reserves, LNG terminal storage, polysilicon at Mundra, bonded-warehouse modules), we publish the <em>commercial + strategic days</em> until the first downstream consumer feels the cut. Russian crude is ~25–30 days (5.33 MMT PPAC strategic reserve + ~17–22 days commercial). Chinese APIs is ~75–90 days (typical pharma raw-material cycle). The headline TTFF stat in the simulator is the <strong className="text-gray-900">minimum</strong> across all active levers — i.e. the first thing that breaks.
          </p>
          ...
          <ul className="space-y-2 text-sm text-gray-600 leading-relaxed mb-4">
          ...
          <p className="text-gray-600 leading-relaxed">
            All 20 lever specifications, including every factor / weight / propagation coefficient, every named population headcount, every cascade step, every historical analogue, and every source URL, are open in the project repository under <code className="font-mono text-xs bg-gray-100 px-1 rounded">src/data/_fragments/</code>. The engine that consumes them is in <code className="font-mono text-xs bg-gray-100 px-1 rounded">src/data/simulatorCoefficients.js</code>. There is nothing computed server-side; the simulator runs entirely in the browser and is fully inspectable.
          </p>
        </motion.section>
