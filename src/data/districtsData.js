export const districtsData = [
  ...
  },
  {
    ...
    name: "Aravalli",
    region: "North Gujarat",
    coordinates: [73.3082, 23.4243],
    tagline: "Banka-Patty's Fluoride Belt, Modasa's Unsolved Bomb",
    pillars: ["Water", "Education", "MigrantDiscrimination", "Agriculture"],
    stats: [
      { label: "Child Wasting (NFHS-5)", value: "23.5% → 29% (worsened)", status: "critical" },
      { label: "Stage of GW Extraction (CGWB 2017)", value: "57.41% (Bhiloda 62.96%)", status: "warning" },
      { label: "2008 Modasa Blast — Final Verdict", value: "All 7 acquitted (Jul 2025)", status: "danger" },
      { label: "Vadagam Riot 2017 — Families Expelled", value: "35 Sindhi Muslim families", status: "critical" },
      { label: "Aug 2024 Floods — Dams at HIGH ALERT", value: "Meshwo & Hathmati 100%", status: "danger" }
    ],
    summary: "Aravalli was carved out of Sabarkantha in 2013 with Modasa as its district headquarters. Officially celebrated as 'the most literate tribal district in Gujarat,' it sits on the southern leg of the Aravalli geological belt — a fluorspar/cryolite/fluorapatite zone locally known as 'Banka-Patty' for the skeletal deformities its groundwater inflicts. CGWB's 2024 Annual Ground Water Quality Report flagged Gujarat among the seven worst-affected fluoride states with peak readings of 25 mg/L, and adjacent-aquifer surveys in Mehsana found ALL government primary schoolchildren with dental fluorosis and several with early skeletal fluorosis by age 9. The district pulse hides what the indicators expose: NFHS-5 (2019-21) recorded Aravalli's under-five wasting rising from 23.5% to 29% — one of the rare child-nutrition metrics in Gujarat moving in the wrong direction during the state's celebrated growth decade — while only 34.8% of births occurred in public health facilities. The political archive is no kinder. The 29 September 2008 Modasa motorcycle bomb at Sukka Bazaar killed a 15-year-old boy and injured over 100 during Ramadan tarawih prayers; in July 2025 the Special NIA Court acquitted all seven Hindutva-linked accused (including former BJP MP Pragya Singh Thakur) citing tampered evidence, ATS misconduct and possibly planted RDX traces — leaving the case unsolved 17 years later. A week after the Vadavali (Patan) attacks of March 2017, a 500-strong mob attacked Sindhi Muslim homes in Vadagam, injuring 12 and forcing 35 families to flee; one resident hid in a forest for 22 days. The state never officially acknowledged the displacement. Beneath all of this runs the climate ledger: in August 2024 the Meshwo and Hathmati dams hit 100% capacity and Bayad's Lank Dam touched 96.82% HIGH ALERT, washing out groundnut and cotton that Bhil cultivators in Bhiloda and Meghraj had already re-sown after the March 2024 unseasonal rain in Malpur and Shamlaji.",
    keyCrises: [
      { year: "2008 / 2025", title: "Modasa Serial Bomb — 17 Years to Acquittal", detail: "Motorcycle bomb at Sukka Bazaar mosque during Ramadan tarawih killed a 15-year-old and injured 100+. NIA charge-sheeted seven Hindutva-linked accused under UAPA, including former BJP MP Pragya Singh Thakur. In July 2025 the Special NIA Court acquitted all seven, citing tampered evidence, ATS misconduct, missing original records and possibly planted RDX traces. The acquittal has been challenged in the Bombay High Court by the victims; Modasa, which became Aravalli's district headquarters in 2013, remains administratively whole and forensically unanswered. (Source: NIA case page, MHA Annual Report 2018-19, Wikipedia, The Federal)" },
      { year: "2017", title: "Vadagam Communal Riot — 35 Sindhi Muslim Families Expelled", detail: "A mob of nearly 500 men armed with wooden staffs, swords and iron pipes attacked Sindhi Muslim homes in Vadagam village a week after the Vadavali (Patan) attacks. 12 people were injured and 35 Sindhi Muslim families fled, with one resident hiding in a nearby forest for 22 days until a rights organisation located him. MHA records show Sabarkantha-Aravalli accounted for 10 of Gujarat's 13 logged communal incidents 2017-22. The state never officially acknowledged the displacement and most Vadagam families never returned home. (Source: MHA Annual Report, NHRC Annual Report 2017-18, The Federal, The Hindu)" },
      { year: "Ongoing", title: "Banka-Patty Fluoride Belt under Aravalli's Hard Rock", detail: "Aravalli sits on the southern Aravalli geological belt — a fluorspar/cryolite/fluorapatite zone whose deep aquifers leach high fluoride into drinking water. CGWB's 2024 Annual Ground Water Quality Report records 9.04% of national samples breaching the 1.5 mg/L permissible limit with peak readings of 25 mg/L in Gujarat. A peer-reviewed adjacent-aquifer survey found ALL government primary schoolchildren with dental fluorosis and early skeletal fluorosis by age 9. Aravalli replicates the contamination geology but maintains no district-level fluorosis registry. INREM's Rajnarayan Indu notes that one unit of fluoride leaches 40 units of calcium from the body. (Source: CGWB Annual GW Quality Report 2024, CGWB Publication 132, Indian Journal of Medical Research / PMC)" },
      { year: "2019-21", title: "NFHS-5 — Child Wasting Climbs in Bhiloda's Tribal Bhil Belt", detail: "Aravalli's district fact-sheet recorded under-five wasting rising from 23.5% (NFHS-4) to 29.0% — one of the rare child-nutrition indicators in Gujarat moving in the wrong direction during the growth decade. Stunting only mildly improved from 50.6% to 47.1%. Just 34.8% of births occurred in public health facilities and only 56% of pregnant women consumed iron-folic-acid supplements for the recommended 100 days. The deterioration concentrates in tribal-dominated Bhiloda (57.57% Scheduled Tribe, 22.3% pucca houses) — a contradiction with Aravalli's celebrated 'most literate tribal district' tag. (Source: RCHIIPS NFHS-5 Gujarat Fact Sheets, MoHFW NFHS-5 Phase II)" },
      { year: "Aug 2024", title: "Meshwo & Hathmati at 100%, Lank Dam on HIGH ALERT", detail: "Between 24-27 August 2024 Aravalli was hammered by 100-263 mm of rainfall in 24 hours. The Gujarat Water Resources Department logged Meshwo and Hathmati dams in Bhiloda at 100% capacity on HIGH ALERT, and Bayad's Lank Dam at 96.82% — leaving downstream villages exposed to controlled releases. Statewide, NDRF rescued 639 and evacuated 1,269; four were confirmed dead, nine missing, 62 houses destroyed, 271 partially damaged. For Bhil cultivators in Bhiloda and Meghraj who had already re-sown groundnut and cotton after the March 2024 unseasonal rain in Malpur and Shamlaji, the August deluge wiped out the kharif crop yet again. State Disaster Response Fund disbursement remained patchy into 2025. (Source: Gujarat WRD daily dam status, NDRF Gujarat ops, GSDMA, ReliefWeb)" }
    ]
  },
  {
    id: "mahisagar",
  ...
  },
  {
    ...
    name: "Patan",
    region: "North Gujarat",
    coordinates: [72.1264, 23.8427],
    tagline: "Solar Parks Above, Dark-Zone Aquifers Below",
    pillars: ["Water", "GreenTech", "Agriculture", "MigrantDiscrimination"],
    stats: [
      { label: "Fluoride — Ranavada village", value: "17.5 mg/L (11× BIS limit)", status: "critical" },
      { label: "Villages above BIS 1.5 mg/L F⁻", value: "40 (Jal Shakti 2018)", status: "critical" },
      { label: "Groundwater Stage of Extraction", value: ">100% since 2004 (CGWB)", status: "critical" },
      { label: "Charanka Solar Park enclosure", value: "5,384 acres, 730 MW", status: "danger" },
      { label: "NFHS-5 under-5 stunting", value: "50.5% — 2nd worst in Gujarat", status: "critical" }
    ],
    summary: "Patan is what an over-engineered land economy looks like when the groundwater beneath it has already collapsed. CGWB has classified Patan block as 'over-exploited' — Stage of Groundwater Extraction above 100% — in every Dynamic Resource Assessment since 2004, and reaffirmed the status in 2009, 2011, 2013, 2020 and 2023. Decadal pre-monsoon water tables have fallen 20–40 metres. The deep tube-well economy now reaches Tertiary aquifers below 150 m, drawing fluoride-rich water that the Ministry of Jal Shakti's 2018 Drinking Water audit found above the BIS 1.5 mg/L limit in 40 Patan villages — with Ranavada village registering 17.5 mg/L, eleven times the safe ceiling. A local fourteen-village survey records 30% dental fluorosis and 8–10% crippling skeletal fluorosis. Salinity from the Little Rann is simultaneously ingressing into Sami, Harij, Radhanpur and Santalpur talukas.\n\nOnto this exhausted geology the state has layered the Charanka Solar Park: 5,384 acres in Santalpur taluka, 730 MW commissioned, thirty-six developers. GPCL described the land as 'unused', but roughly 2,000 acres were under cultivation and Maldhari pastoral commons, including the gauchar of Survey 152. Of about a hundred livestock families with ~35,000 sheep and 1,200 cows before the park, only twenty still own animals; the nearest grazing is now eight to ten kilometres away. A 2014 PIL by farmer Farsubhai Goklani — land bought at ₹1 lakh/acre and revalued at ₹6.9 lakh/acre — was dismissed by the Gujarat High Court in March 2015, and a 2017 MoEFCC office memorandum exempted utility-scale solar PV from EIA review altogether.\n\nThe human indicators have not improved alongside the megawatts. NFHS-5 (2019–21) records 50.5% under-five stunting in Patan, second-worst in Gujarat after Dahod and far above the state average of 39%, with childhood anaemia also rising. Patan is one of thirteen Gujarat districts where child stunting WORSENED between NFHS-4 and NFHS-5 despite the GMERS Medical College opening in Dharpur in 2011. In July 2023, after social-media posts circulated around the 'Kerala Story' film, mob violence in Balisana injured eight people and torched two Muslim shops; viral video showed accused paraded through Masjid Chowk during police 'crime reconstruction'. NCRB Crime in India 2022 records Gujarat's SC-atrocity conviction rate at 3.06% over 2018–21.",
    keyCrises: [
      { year: "2018-Ongoing", title: "Fluoride Contamination — Ranavada at 11× the limit", detail: "Ministry of Jal Shakti / DDWS 2018 audit found 40 Patan villages with groundwater fluoride above the BIS 1.5 mg/L drinking-water limit. Ranavada village measured 17.5 mg/L — eleven times the safe ceiling. Kumar et al. 2017 recorded fluoride 0.4–4.8 mg/L across the Patan groundwater system. A 14-village local survey documented 30% dental fluorosis and 8–10% crippling skeletal fluorosis. (Sources: CGWB Annual Groundwater Quality Report 2024; DDWS / Jal Shakti drinking-water status; Kumar et al., ScienceDirect 2017; PIB)" },
      { year: "2012-Ongoing", title: "Charanka Solar Park — 5,384 acres, dismissed PIL", detail: "GPCL's Charanka Solar Park in Santalpur taluka encloses 5,384 acres for 730 MW across 36 developers. Roughly 2,000 acres were under cultivation and Maldhari grazing commons before acquisition; of about 100 pastoralist families with ~35,000 sheep and 1,200 cows pre-park, only ~20 still own livestock and nearest grazing is now 8–10 km away. A 2014 PIL by farmer Farsubhai Goklani (land bought at ₹1 lakh/acre, revalued ₹6.9 lakh/acre) was dismissed by the Gujarat High Court in March 2015; a 2017 MoEFCC OM exempted solar PV from EIA review. (Sources: GPCL Charanka page; MNRE; MoEFCC EIA notification 2017; Business Standard; Mongabay; Yenneti & Day, procedural-injustice study)" },
      { year: "2004-Ongoing", title: "CGWB Dark-Zone — Over-Exploited since 2004", detail: "CGWB has classified Patan block as 'over-exploited' — Stage of Groundwater Extraction above 100% — in every Dynamic Resource Assessment since 2004, reaffirmed in 2009, 2011, 2013, 2020 and 2023. Decadal pre-monsoon water levels have fallen 20–40 m. NAQUIM 2020 documents deep tube-wells below 150 m drawing fluoride-rich Tertiary aquifers. Salinity from the Little Rann is ingressing into Sami, Harij, Radhanpur and Santalpur talukas; GWSSB lists 2,571 Gujarat villages with high-salinity groundwater. (Sources: CGWB NAQUIM Patan; CGWB Annual Groundwater Quality Report 2024; patan.nic.in district-at-a-glance)" },
      { year: "2019-21", title: "NFHS-5 Child Stunting — 2nd Worst in Gujarat", detail: "NFHS-5 (2019–21) records 50.5% under-five stunting in Patan, second-worst in Gujarat after Dahod (55.3%) and far above the state average of 39%. Patan is one of 13 Gujarat districts where child stunting WORSENED between NFHS-4 and NFHS-5, with childhood anaemia also rising. The GMERS Medical College in Dharpur opened in 2011 has not shifted the needle; 66.5% of cropping remains rainfed per KVK Patan 2013-14. (Sources: RCHIIPS NFHS-5 Patan fact-sheet; MoHFW NFHS-5; KVK Patan)" },
      { year: "2023", title: "Balisana Communal Clash — 16 July 2023", detail: "Mob violence in Balisana village on 16 July 2023, after social-media posts around the 'Kerala Story' film, injured 8 people and torched 2 Muslim shops. Patan police filed cross-FIRs and arrested 10 (8 Muslim, 2 Hindu); viral video showed accused paraded through Masjid Chowk during police 'crime reconstruction'. In Hajipur village separately, 2 Dalit students were forced by a principal to clean toilets. NCRB Crime in India 2022 records Gujarat's SC-atrocity conviction rate at 3.06% over 2018–21. (Sources: NCRB Crime in India 2022; The Federal report on Balisana; patan.nic.in)" }
    ]
  },
  {
    id: "panchmahal",
  ...
  },
  {
    ...
    name: "Sabarkantha",
    region: "North Gujarat",
    coordinates: [73.0116, 23.6174],
    tagline: "The Dairy Mirage and the 2018 Anti-Migrant Pogrom",
    pillars: ["MigrantDiscrimination", "Agriculture", "Water", "Economics"],
    stats: [
      { label: "2018 anti-migrant exodus", value: "20,000–50,000 fled", status: "critical" },
      { label: "Sabar Dairy turnover FY25", value: "~₹9,500 cr (vs ₹6,805 cr FY22)", status: "warning" },
      { label: "Sabar Dairy farmer revolt", value: "Plant stormed, July 2025", status: "danger" },
      { label: "Aquifer levels (adjacent blocks)", value: ">190 m below ground", status: "critical" },
      { label: "BT cotton Cry1Ac resistance", value: "27% rosette, up to 90% local loss", status: "critical" }
    ],
    summary: "Sabarkantha is a district shaped by two things at once: a dairy economy whose growth no longer reaches its producers, and a 2018 migrant pogrom that the state has never fully named. On 28 September 2018, a 14-month-old Thakor girl was allegedly raped in Dhundhar village near Himatnagar by Ravindra Sahu, a Bihari migrant ceramic worker. Within seventy-two hours, the Kshatriya Thakor Sena — which claims 100,000 members — marched through Himatnagar with posters of a sword stabbing a 'bhaiyya'. The violence spread to Sabarkantha, Mehsana, Gandhinagar, Patan, Banaskantha, Aravalli and Ahmedabad, with Sabarkantha and Mehsana the worst-hit. By 8 October, 55 FIRs were filed, 431 arrests made, and the Uttar Bharatiya Vikas Parishad estimated 20,000–50,000 migrant workers had fled North Gujarat. Simultaneously, Chief Minister Vijay Rupani pushed an 80% Gujarati-jobs reservation.\n\nThe agrarian backbone is fraying under its own success metrics. Sabar Dairy — Gujarat's third-largest dairy union after Amul-Anand and Banas, with 3.85 lakh member-farmers across 1,780 village societies — grew turnover from ₹6,805 crore (FY22) to ₹8,939 crore (FY24) to roughly ₹9,500 crore in 2025, while procurement prices to its members stagnated. In July 2025, thousands of farmers stormed the Himatnagar plant demanding a 25% price hike, smashing CCTV equipment before tear gas and lathi-charge dispersed them; at least three were injured. Idar taluka farmer Mehulbhai Dabhi of Badarpura recorded roughly ₹8 lakh in losses since 2022 from successive rain damage. BT cotton compounds the collapse: Sabarkantha grows 1.6 lakh hectares of North Gujarat's 3.4 lakh-hectare cotton belt, ~85% planted with Bollgard-II. Pink bollworm Cry1Ac resistance — first documented in Saurashtra in 2009 — entered the North Zone after 2018; field surveys record 27% rosette formation and yield losses of up to 30% generally, 90% locally. A 2025 Nature Scientific Reports paper confirms stacked Cry1Ac+Cry2Ab resistance.\n\nUnder both layers, the water economy is hollowing. The district sits on Archaean-Proterozoic hard rock with weathered fracture zones under 40 metres below ground, but extraction in adjacent blocks has pushed water tables past 190 m. CGWB Dynamic Groundwater Resource assessments repeatedly classify Sabarkantha blocks as 'Semi-Critical' to 'Over-Exploited'. The August 2024 deluge destroyed North Gujarat's kharif crop; the state announced a ₹1,419.62 crore relief package whose disbursement on the ground has been minimal. APMC yards without covered storage left harvested produce to rot.",
    keyCrises: [
      { year: "2018", title: "Anti-Migrant Pogrom — 20,000–50,000 Fled North Gujarat", detail: "On 28 Sep 2018 a 14-month-old Thakor girl was allegedly raped in Dhundhar village by Bihari migrant Ravindra Sahu. Within 72 hours the Kshatriya Thakor Sena (claims 100,000 members) marched in Himatnagar with posters of a sword stabbing a 'bhaiyya'. Violence spread to Sabarkantha, Mehsana, Gandhinagar, Patan, Banaskantha, Aravalli, Ahmedabad — Sabarkantha + Mehsana worst hit. By 8 Oct: 55 FIRs, 431 arrests, 20,000–50,000 migrants fled (Uttar Bharatiya Vikas Parishad estimate). CM Vijay Rupani simultaneously pushed 80% Gujarati-jobs reservation. (Sources: Sabarkantha District Court; PUDR press statement; The Hindu; Indian Express)" },
      { year: "2022-2025", title: "Sabar Dairy Farmer Revolt — Plant Stormed July 2025", detail: "Sabar Dairy — Gujarat's 3rd-largest dairy union after Amul-Anand and Banas, 3.85 lakh member-farmers across 1,780 village societies — grew turnover from ₹6,805 cr (FY22) to ₹8,939 cr (FY24) to ~₹9,500 cr (2025) while procurement prices to members stagnated. In July 2025, thousands of farmers stormed the Himatnagar plant demanding a 25% price hike, smashed CCTV equipment, faced tear-gas + lathi-charge — 3+ injured. Idar taluka farmer Mehulbhai Dabhi of Badarpura reports ~₹8 lakh in losses since 2022 from successive rain damage. (Sources: sabardairy.org turnover page; sabardairy.org organization structure; The Federal report on storming)" },
      { year: "2018-2025", title: "BT Cotton Cry1Ac Resistance Collapse", detail: "Sabarkantha grows 1.6 lakh hectares of North Gujarat's 3.4 lakh-ha cotton belt, ~85% Bollgard-II. Pink bollworm Cry1Ac resistance first confirmed in Saurashtra 2009 entered the North Zone after 2018. Field surveys record 27% rosette formation and yield losses of up to 30% (locally 90%). Stacked Cry1Ac+Cry2Ab resistance documented by 2014 and validated in Nature Scientific Reports 2025. Farmers are forced back to chemical insecticides. (Sources: Nature Scientific Reports 2025; NIH PMC pink-bollworm resistance studies)" },
      { year: "Ongoing", title: "Aquifer Collapse — Adjacent Blocks Past 190 m", detail: "Sabarkantha sits on Archaean/Proterozoic hard rock with weathered fracture zones under 40 m below ground, but extraction in adjacent blocks has pushed water tables past 190 metres below surface. CGWB Dynamic Groundwater Resource assessments repeatedly classify Sabarkantha blocks as 'Semi-Critical' to 'Over-Exploited'. Recharge is well below extraction. (Sources: CGWB resource assessment; PIB Groundwater Resource Assessment 2022)" },
      { year: "2024", title: "August Deluge & Unpaid ₹1,419 cr Relief", detail: "The August 2024 extreme monsoon destroyed North Gujarat's kharif crop. The state announced a ₹1,419.62 crore relief package whose disbursement on the ground has been minimal per field reporting. APMC yards without covered storage left harvested produce to rot. The Federal documented Bhavnagar groundnut and North Gujarat cotton losses; PMFBY claims-settlement lag remains unresolved. (Sources: DC-MSME Sabarkantha DIPS; The Federal report on rain-damaged crops)" }
    ]
  }
];
